...
const DemandeConge = () => {
  const [demandes, setDemandes] = useState([
    {
      id: 1,
      employe: { nom: 'Rakoto', prenom: 'Jean', photo: null },
      type_conge: 'Congé annuel',
      date_debut: '2025-12-01',
      date_fin: '2025-12-10',
      nombre_jours: 10,
      motif: 'Vacances familiales',
      date_demande: '2025-11-15',
      statut: 'EN_ATTENTE'
    },
    {
      id: 2,
      employe: { nom: 'Rasoa', prenom: 'Marie', photo: null },
      type_conge: 'Congé maladie',
      date_debut: '2025-11-25',
      date_fin: '2025-11-27',
      nombre_jours: 3,
      motif: 'Grippe',
      date_demande: '2025-11-20',
      statut: 'EN_ATTENTE'
    },
    {
      id: 3,
      employe: { nom: 'Andriana', prenom: 'Paul', photo: null },
      type_conge: 'Congé exceptionnel',
      date_debut: '2025-11-30',
      date_fin: '2025-12-02',
      nombre_jours: 3,
      motif: 'Mariage',
      date_demande: '2025-11-18',
      statut: 'EN_ATTENTE'
    }
  ]);
  ...
  const handleValidation = () => {
    ...
    setDemandes(demandes.map(d => 
      d.id === selectedDemande.id 
        ? { ...d, statut: newStatut, commentaire_validation: commentaire }
        : d
    ));
          ...
          <CardContent sx={{ p: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3 }}>
              <Typography variant="h6" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                Demandes en attente
                <Chip 
                  label={demandesEnAttente.length} 
                  color="warning" 
                  size="small"
                  sx={{ ml: 1 }}
                />
                  ...
                  <TableBody>
                    {demandesEnAttente.map((demande) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Chip 
                            label={demande.type_conge} 
                            color={getTypeColor(demande.type_conge)}
                            size="small"
                          />
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell align="right">
                          <Stack direction="row" spacing={1} justifyContent="flex-end">
                            <Button
                              ...
                              onClick={() => handleOpenDialog(demande, 'valider')}
                            >
                              Valider
                            </Button>
                            <Button
                              ...
                              size="small"
                              startIcon={<Cancel />}
                              onClick={() => handleOpenDialog(demande, 'rejeter')}
                            >
                              Rejeter
                            </Button>
                          </Stack>
        ...
        >
              ...
              <Box>
                <Box sx={{ mb: 3, p: 2, bgcolor: 'rgba(126, 87, 194, 0.1)', borderRadius: 2 }}>
                  ...
                  <Typography variant="body1">
                    ...
                    {' '}({selectedDemande.nombre_jours} jours)
                  </Typography>
                </Box>
                ...
                <TextField
                  ...
                  placeholder={`Ajoutez un commentaire pour ${actionType === 'valider' ? 'la validation' : 'le rejet'}...`}
                  sx={{ mt: 2 }}
                />
              </Box>
            )}
          ...
          <DialogActions sx={{ p: 3, borderTop: 1, borderColor: 'divider' }}>
            ...
            <Button 
              ...
              startIcon={actionType === 'valider' ? <CheckCircle /> : <Cancel />}
            >
              Confirmer
            </Button>
          </DialogActions>
